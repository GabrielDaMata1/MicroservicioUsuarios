...
{
    public class UsuarioModificadoConsumer : IConsumer<UsuarioModificadoEvent>
    {
        private readonly IUsuarioService _usuarioService;

        public UsuarioModificadoConsumer(IUsuarioService usuarioService)
        {
            _usuarioService = usuarioService;
        }

        public async Task Consume(ConsumeContext<UsuarioModificadoEvent> context)
        {
            ...
            await _usuarioService.ActualizarUsuarioMongoAsync(context.Message.correoActualUsuario, usuarioMongo);
        }
    }
}